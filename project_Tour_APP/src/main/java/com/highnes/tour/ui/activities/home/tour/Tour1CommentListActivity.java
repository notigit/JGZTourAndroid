 ...
 * </PRE>
 */
public class Tour1CommentListActivity extends BaseTitleActivity implements OnRefreshListener {
	private ListView lvList;
	private PullToRefreshLayout pull;
	private Tour1CommentAdapter adapter;
	// 没有数据的时候显示
	...
	protected void initView2T(Bundle savedInstanceState) {
		...
		adapter = new Tour1CommentAdapter(mContext);
