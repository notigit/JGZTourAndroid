package com.highnes.tour.view.listview;
...
public class MyLinListView extends LinearLayout {
			...
			v.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					if (onItemClickListener != null) {
						onItemClickListener.onItemClick(MyLinListView.this, layout, index, adapter.getItem(index));
					}
				}
			});
			ImageView imageView = new ImageView(getContext());
			imageView.setBackgroundResource(R.color.line_ebf1f0);
	...
	public MyLinListView(Context context) {
		super(context);
		initAttr(null);
	}

	public MyLinListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initAttr(attrs);
	}
