...
public class AutoScrollPoster extends AutoScrollableView<String> {
	...
	private void init() {
		...
		mDisplayImageOptions = new DisplayImageOptions.Builder().showImageOnLoading(R.drawable.ic_default_img).showImageForEmptyUri(R.drawable.ic_default_img)
		...
		imageView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (mOnItemViewClickListener != null) {
					mOnItemViewClickListener.onItemViewClick(v, imageUri, position);
				}
			}
		});
	...
	public static interface OnItemViewClickListener {
		...
		void onItemViewClick(View view, Object object, int position);
