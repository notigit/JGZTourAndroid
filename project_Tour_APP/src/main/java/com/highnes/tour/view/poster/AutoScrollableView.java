package com.highnes.tour.view.poster;
...
public abstract class AutoScrollableView<T> extends AutoScrollViewPager implements IPagerAdapter {
	 ...
	 * 
	 * @see
	 * com.wo2b.sdk.view.viewpager.IPagerAdapter#destroyItem(android.view.ViewGroup
	...
	// /* (non-Javadoc)
	// * @see
	// com.wo2b.sdk.view.viewpager.IPagerAdapter#instantiateItem(android.view.ViewGroup,
	// int)
	// */
	// @Override
	 ...
	 * 
	 * @see
	 * com.wo2b.sdk.view.viewpager.IPagerAdapter#isViewFromObject(android.view
	 ...
	 * 
	 * @see
	 * com.wo2b.sdk.view.viewpager.IPagerAdapter#restoreState(android.os.Parcelable
