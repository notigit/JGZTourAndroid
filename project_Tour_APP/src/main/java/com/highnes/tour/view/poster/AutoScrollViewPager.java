...
public class AutoScrollViewPager extends ViewPagerCompat {
	 ...
	 * 默认切换周期
	 */
	private static final int SCROLL_PERIOD_DEFAULT = 5 * 1000;
...
//		if(onCurrItem!=null){
//			onCurrItem.onCurrItem(mBeginIndex);
//		}
	...
	protected void scrollSelf() {
		...
		try {
			...
			e.printStackTrace();
			this.setCurrentItem(getCurrentItem(), true);
		}
	
//		if(onCurrItem!=null){
//			onCurrItem.onCurrItem(newPosition);
//		}
		try {
			field = ViewPagerCompat.class.getDeclaredField("mScroller");
			field.setAccessible(true);
