...
public class ECAlertDialog extends Dialog implements View.OnClickListener {
	...
	public static final String TAG = "ECAlertDialog";
	/** 左边按钮 */
	...
	public ECAlertDialog(Context context) {
		...
		if (AppManager.getAppManager().currentActivity() != null) {
			mTintManager = new SystemBarTintManager(AppManager.getAppManager().currentActivity());
		}
	}
	...
	public static ECAlertDialog buildAlert(Context ctx, int resId, OnClickListener negativeClickListener, OnClickListener positive) {
		return buildAlert(ctx, ctx.getString(resId), ctx.getString(R.string.dialog_btn_cancel), ctx.getString(R.string.dialog_btn_confim),
				negativeClickListener, positive);
	}

	public static ECAlertDialog buildAlert(Context ctx, CharSequence message, OnClickListener listener) {
	...
	public static ECAlertDialog buildAlert(Context ctx, CharSequence message, OnClickListener negativeClickListener, OnClickListener positive) {
	...
	public static ECAlertDialog buildAlert(Context ctx, int message, int leftBtnText, int rightText, OnClickListener negativeClickListener,
	 ...
	 * @return
	 */
	public static ECAlertDialog buildAlert(Context ctx, CharSequence message, CharSequence leftBtnText, CharSequence rightText,
			OnClickListener negativeClickListener, OnClickListener positive) {
	 ...
	 * @return
	 */
	public static ECAlertDialog buildAlert(Context ctx, CharSequence message, CharSequence text, OnClickListener positive) {
		ECAlertDialog dialog = new ECAlertDialog(ctx);
		dialog.setMessage(message);
