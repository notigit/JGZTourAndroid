package com.highnes.tour.view.layout;
...
public class RippleView extends RelativeLayout {
    ...
    private int DURATION = 100; //持续时间
    private int PAINT_ALPHA = 155; //透明度
    ...
    private void init(final Context context, final AttributeSet attrs) {
        ...
        zoomDuration = typedArray.getInt(R.styleable.RippleView_rv_zoomDuration, 80);
        typedArray.recycle();
        paint = new Paint();
