 ...
 * </PRE>
 */
public class Tour4AreaAdapter extends BaseListAdapter<Tour4Info.HotTourismInfo> {

	public Tour4AreaAdapter(Context paramContext) {
		super(paramContext);
		initOptions();
	}
	...
	public View getView(final int position, View view, ViewGroup viewGroup) {
		...
		Tour4Info.HotTourismInfo info = (Tour4Info.HotTourismInfo) getItem(position);
		// 设置页面显示值
