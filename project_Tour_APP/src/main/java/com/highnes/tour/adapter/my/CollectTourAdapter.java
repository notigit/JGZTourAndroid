 ...
 * </PRE>
 */
public class CollectTourAdapter extends BaseListAdapter<CollectTourInfo.TourismkeepInfo> {

	public CollectTourAdapter(Context paramContext) {
		super(paramContext);
		initOptions();
	}
	...
	public View getView(final int position, View view, ViewGroup viewGroup) {
		...
		CollectTourInfo.TourismkeepInfo info = (CollectTourInfo.TourismkeepInfo) getItem(position);
		// 设置页面显示值
