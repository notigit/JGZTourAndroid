 ...
 * </PRE>
 */
public class FilterListThemeAdapter extends BaseListAdapter<TicketFilterInfo.AreaTypeInfo> {
	// 当前选择的Item
	private int index = 0;
	...
	public FilterListThemeAdapter(Context paramContext) {
		super(paramContext);
	}
	...
	public View getView(int position, View view, ViewGroup viewGroup) {
		...
		TicketFilterInfo.AreaTypeInfo info = (TicketFilterInfo.AreaTypeInfo) getItem(position);
		holder.tvName.setText(info.TypeName);
		if(index == position){
			//选中的item
