 ...
 * </PRE>
 */
public class Tour2HotAdapter extends BaseListAdapter<Tour2Info.HotCityInfo> {

	public Tour2HotAdapter(Context paramContext) {
		super(paramContext);
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		// 绑定消息到列表中。
		Tour2Info.HotCityInfo items = (Tour2Info.HotCityInfo) getItem(position);
		listCell.tvName.setText(items.CityName);
