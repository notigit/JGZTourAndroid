 ...
 * </PRE>
 */
public class Tour1FilterListAdapter extends BaseListAdapter<Tour1FilterListInfo.TourismsInfo> {

	public Tour1FilterListAdapter(Context paramContext) {
		super(paramContext);
		initOptions();
	}
	...
	public View getView(final int position, View view, ViewGroup viewGroup) {
		...
		if (view == null) {
			...
			holder.tvTag2 = (TextView) view.findViewById(R.id.tv_item_tag2);
		...
		Tour1FilterListInfo.TourismsInfo info = (Tour1FilterListInfo.TourismsInfo) getItem(position);
		// 设置页面显示值
	...
	private class ViewHolder {
		...
		private TextView tvTag0, tvTag1,tvTag2;
	}
}
