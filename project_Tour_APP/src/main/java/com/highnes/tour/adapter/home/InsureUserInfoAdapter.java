 ...
 * </PRE>
 */
public class InsureUserInfoAdapter extends BaseListAdapter<CommonUserInfo.PeopleInfo> {

	// 是否是选择的模式
	private boolean isSelect = false;

	public InsureUserInfoAdapter(Context paramContext, boolean isSelect) {
		super(paramContext);
	...
	public View getView(final int position, View view, ViewGroup viewGroup) {
		...
		if (view == null) {
			...
			view = LayoutInflater.from(mContext).inflate(R.layout.item_home_insure_userinfo, null);
