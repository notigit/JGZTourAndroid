 ...
 * </PRE>
 */
public class TicketFilterListAdapter extends BaseListAdapter<TicketFilterListInfo.SoldInfo> {
	private LatLng mLatlng;

	public TicketFilterListAdapter(Context paramContext) {
		super(paramContext);
		initOptions();
	...
	public View getView(final int position, View view, ViewGroup viewGroup) {
		...
		TicketFilterListInfo.SoldInfo info = (TicketFilterListInfo.SoldInfo) getItem(position);
		// 设置页面显示值
		...
		// 距离 自己计算距离
		LatLng latLngShop = new LatLng(info.Latitude, info.Landmark);
		// 距离计算
