 ...
 * </PRE>
 */
public class Tour6TopAdapter extends BaseListAdapter<Tour6Info.HotCityInfo> {

	public Tour6TopAdapter(Context paramContext) {
		super(paramContext);
		initOptions();
	}
	...
	public View getView(final int position, View view, ViewGroup viewGroup) {
		...
		Tour6Info.HotCityInfo info = (Tour6Info.HotCityInfo) getItem(position);
		holder.tvTitle.setText(info.CityName);
