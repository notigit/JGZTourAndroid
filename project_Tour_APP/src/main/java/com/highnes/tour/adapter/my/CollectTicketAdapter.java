 ...
 * </PRE>
 */
public class CollectTicketAdapter extends BaseListAdapter<CollectTicketInfo.SoldkeepInfo> {

	public CollectTicketAdapter(Context paramContext) {
		super(paramContext);
		initOptions();
	}
	...
	public View getView(final int position, View view, ViewGroup viewGroup) {
		...
		CollectTicketInfo.SoldkeepInfo info = (CollectTicketInfo.SoldkeepInfo) getItem(position);
		// 设置页面显示值
