 ...
 * </PRE>
 */
public class Tour1AreaAdapter extends BaseListAdapter<Tour1Info.TourismsInfo> {

	public Tour1AreaAdapter(Context paramContext) {
		super(paramContext);
		initOptions();
	}
	...
	public View getView(final int position, View view, ViewGroup viewGroup) {
		...
		Tour1Info.TourismsInfo info = (Tour1Info.TourismsInfo) getItem(position);
		// 设置页面显示值
