 ...
 * </PRE>
 */
public class FilterListFilterAdapter extends BaseListAdapter<TicketFilterInfo.SiftingsInfo.SiftingInfo> {
	...
	private class MyOnCheckedChangeListener implements OnCheckedChangeListener {
		TicketFilterInfo.SiftingsInfo.SiftingInfo info;
		LinearLayout root;
		int position;

		public MyOnCheckedChangeListener(TicketFilterInfo.SiftingsInfo.SiftingInfo info, LinearLayout root,int position) {
			this.info = info;
			this.root = root;
	...
	private class MyOnClickListener implements OnClickListener {
		...
		public MyOnClickListener(TicketFilterInfo.SiftingsInfo.SiftingInfo info, LinearLayout root,CheckBox cbSelect,int position) {
			this.info = info;
			this.root = root;
	...
	public interface OnChecked {
		 ...
		 */
		void onChecked(TicketFilterInfo.SiftingsInfo.SiftingInfo info,int position);
	}
