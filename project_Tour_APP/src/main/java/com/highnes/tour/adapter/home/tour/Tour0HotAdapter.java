 ...
 * </PRE>
 */
public class Tour0HotAdapter extends BaseListAdapter<Tour0Info.SoldInfo> {
	private LatLng mLatlng;

	public Tour0HotAdapter(Context paramContext) {
		super(paramContext);
		initOptions();
	...
	public View getView(final int position, View view, ViewGroup viewGroup) {
		...
		Tour0Info.SoldInfo info = (Tour0Info.SoldInfo) getItem(position);
		// 设置页面显示值
