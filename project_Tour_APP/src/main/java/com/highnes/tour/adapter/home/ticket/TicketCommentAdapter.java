 ...
 * </PRE>
 */
public class TicketCommentAdapter extends BaseListAdapter<TicketDetailInfo.GoodComInfo> {

	public TicketCommentAdapter(Context paramContext) {
		super(paramContext);
		initOptions();
	}
	...
	public View getView(final int position, View view, ViewGroup viewGroup) {
		...
		TicketDetailInfo.GoodComInfo info = (TicketDetailInfo.GoodComInfo) getItem(position);
	...
	private class MyOnItemClickListener implements OnItemClickListener {
		TicketDetailInfo.GoodComInfo info;

		public MyOnItemClickListener(TicketDetailInfo.GoodComInfo info) {
			this.info = info;
		}
	...
	public interface OnItemCall {
		void onCall(TicketDetailInfo.GoodComInfo info,int position);
	}
