 ...
 * </PRE>
 */
public class PHPCollectAdapter extends BaseListAdapter<PHPCollectInfo.DataInfo> {

	public PHPCollectAdapter(Context paramContext) {
		super(paramContext);
		initOptions();
	}
	...
	public View getView(final int position, View view, ViewGroup viewGroup) {
		...
		PHPCollectInfo.DataInfo info = (PHPCollectInfo.DataInfo) getItem(position);
		// 设置页面显示值
		holder.tvTitle.setText(info.title);
		holder.tvInfo.setText(info.destitle);
		ImageLoader.getInstance().displayImage(info.coversrc, holder.ivImg, options, null);
		return view;
	}
