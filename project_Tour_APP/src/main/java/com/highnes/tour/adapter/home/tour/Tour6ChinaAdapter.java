 ...
 * </PRE>
 */
public class Tour6ChinaAdapter extends BaseListAdapter<Tour6Info.HotTourismInfo> {

	public Tour6ChinaAdapter(Context paramContext) {
		super(paramContext);
		initOptions();
	}
	...
	public View getView(final int position, View view, ViewGroup viewGroup) {
		...
		if (view == null) {
			...
			view = LayoutInflater.from(mContext).inflate(R.layout.item_home_tour_6_china, null);
