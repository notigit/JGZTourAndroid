 ...
 * </PRE>
 */
public class Tour1CommentAdapter extends BaseListAdapter<TourDetailInfo.CommInfo> {

	public Tour1CommentAdapter(Context paramContext) {
		super(paramContext);
		initOptions();
	}
	...
	public View getView(final int position, View view, ViewGroup viewGroup) {
		...
		TourDetailInfo.CommInfo info = (TourDetailInfo.CommInfo) getItem(position);
	...
	private class MyOnItemClickListener implements OnItemClickListener {
		TourDetailInfo.CommInfo info;

		public MyOnItemClickListener(TourDetailInfo.CommInfo info) {
			this.info = info;
		}
	...
	public interface OnItemCall {
		void onCall(TourDetailInfo.CommInfo info,int position);
	}
