 ...
 * </PRE>
 */
public class Tour5ChinaAdapter extends BaseListAdapter<Tour5Info.HotTourismInfo> {

	public Tour5ChinaAdapter(Context paramContext) {
		super(paramContext);
		initOptions();
	}
	...
	public View getView(final int position, View view, ViewGroup viewGroup) {
		...
		Tour5Info.HotTourismInfo info = (Tour5Info.HotTourismInfo) getItem(position);
