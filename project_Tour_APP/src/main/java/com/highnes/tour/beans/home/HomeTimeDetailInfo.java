 ...
 * </PRE>
 */
public class HomeTimeDetailInfo {
	 ...
	 *            购票
	 */
	public HomeTimeDetailInfo(String status, String areaID, String areaName, String city, String comcount, String landmark, String latitude, String payPhone,
			String soldTime, String soldkeep, List<ImageUrlsInfo> imageUrls, List<GoodComInfo> goodCom) {
		super();
		this.status = status;
		AreaID = areaID;
		AreaName = areaName;
	...
	public static class SoldInfo {
		 ...
		 *            标题
		 */
		public SoldInfo(String clienteleUser, String isRefunds, String isReserved, String isUpdate, String newPrice, String oldPrice, String sID, String sType,
				String soldName, String title) {
			super();
